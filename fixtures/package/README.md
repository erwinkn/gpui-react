...
`bun scripts/test-packages.ts /path/to/archives` installs the three
...
The application uses all five standard controls from `@gpui-react/kit`. It checks the first native
